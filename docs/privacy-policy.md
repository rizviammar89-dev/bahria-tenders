...
- **Account information (via Google Sign-In).** When you sign in with Google, we receive your
  name, email address, and profile picture. We do not receive your Google password.
- **Phone number.** You provide your phone number during profile setup so residents and providers
  can contact each other about a job.
- **Location.** If you use the app as a service provider and set yourself as *Available/Working*,
  we collect your device location and share it with residents so they can see nearby providers on a
  map and estimate distance. Location sharing **stops when you set yourself Unavailable**. Residents'
...
- **Device / push token.** A push notification token so we can send you job alerts and messages.
...
- **With service providers who run our infrastructure:**
  ...
  - **Safepay** — payment processing for provider subscriptions.
- **When required by law**, or to protect the rights, safety, and security of users and the service.

## Data retention
We keep your information for as long as your account is active. If you delete your account or ask us
to delete your data, we remove your personal data except where we are required to keep certain
records (for example, payment records) by law.

## Your choices and rights
- **Location:** you control location sharing by toggling Available/Unavailable, and via your device
  settings. Denying location will limit provider features.
